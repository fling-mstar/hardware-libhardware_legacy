...
enum audio_source {
    ...
    // bluetooth hid mic profile from broadcom
    AUDIO_SOURCE_BT_MIC = 9, // Match the ENUM value in audio_source_t (system/audio.h)
    AUDIO_SOURCE_A2DP = 10,
    AUDIO_SOURCE_CAPTURE_DEV0 = 11,
    AUDIO_SOURCE_CAPTURE_DEV1 = 12,
    AUDIO_SOURCE_MAX = AUDIO_SOURCE_CAPTURE_DEV1,
...
// Two mm play support speaker and line out
        ...
        MUSIC_SUB        = 10,// Two MM play, use MUSIC_SUB to play in other device 
#endif
// MStar Android Patch End
        NUM_STREAM_TYPES
    };
    ...
    enum audio_devices {
        ...
        DEVICE_IN_ALL = (DEVICE_IN_COMMUNICATION | DEVICE_IN_AMBIENT | DEVICE_IN_BUILTIN_MIC |
                ...
                DEVICE_IN_VOICE_CALL | DEVICE_IN_BACK_MIC | DEVICE_IN_BLUETOOTH_MIC | DEVICE_IN_DEFAULT)
        // MStar Android Patch End
    };
